...
goog.addDependency = function(a, b, c, d) {
    if (goog.DEPENDENCIES_ENABLED) {
        var e;
        a = a.replace(/\\/g, "/");
        for (var f = goog.dependencies_,
        g = 0; e = b[g]; g++) f.nameToPath[e] = a,
        f.pathIsModule[a] = !!d;
...
goog.crypt.stringToByteArray = function(a) {
    for (var b = [], c = 0, d = 0; d < a.length; d++) {
        for (var e = a.charCodeAt(d); 255 < e;) b[c++] = e & 255,
        e >>= 8;
        b[c++] = e
    }
    return b
...
goog.crypt.byteArrayToString = function(a) {
    ...
    for (var b = "",
    c = 0; c < a.length; c += 8192) var d = goog.array.slice(a, c, c + 8192),
...
goog.crypt.base64.decodeString = function(a, b) {
    ...
    var c = "";
    goog.crypt.base64.decodeStringInternal_(a,
    function(a) {
...
goog.json.Serializer.prototype.serializeString_ = function(a, b) {
    b.push('"', a.replace(goog.json.Serializer.charsToReplace_,
    function(a) {
...
jspb.Map.prototype.toArray = function() {
    if (this.arrClean) {
        if (this.valueCtor_) {
            var a = this.map_,
            b;
            for (b in a) Object.prototype.hasOwnProperty.call(a, b) && a[b].valueWrapper.toArray()
        }
    } else {
        this.arr_.length = 0;
        a = this.stringKeys_();
...
jspb.Map.prototype.serializeBinary = function(a, b, c, d, e) {
    ...
    for (var g = 0; g < f.length; g++) {
        ...
        b.beginSubMessage(a);
        c.call(b, 1, h.key);
        this.valueCtor_ ? d.call(b, 2, this.wrapEntry_(h), e) : valueWriterFn_.call(b, 2, h.value);
        b.endSubMessage()
    }
};
jspb.Map.deserializeBinary = function(a, b, c, d, e) {
    for (var f = void 0,
    g = void 0; b.nextField() && !b.isEndGroup();) {
...
jspb.Message.initialize = function(a, b, c, d, e, f) {
    ...
    if (e) for (b = 0; b < e.length; b++) c = e[b],
    c < a.pivot_ ? (c = jspb.Message.getIndex_(a, c), a.array[c] = a.array[c] || (jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? jspb.Message.EMPTY_LIST_SENTINEL_: [])) : a.extensionObject_[c] = a.extensionObject_[c] || (jspb.Message.MINIMIZE_MEMORY_ALLOCATIONS ? jspb.Message.EMPTY_LIST_SENTINEL_: []);
...
jspb.Message.serializeBinaryExtensions = function(a, b, c, d) {
    for (var e in c) {
        ...
        var h = d.call(a, g);
        if (h) if (g.isMessageType()) if (f.binaryMessageSerializeFn) f.binaryWriterFn.call(b, g.fieldIndex, h, f.binaryMessageSerializeFn);
...
jspb.Message.getMapField = function(a, b, c, d) {
    ...
    if (!c) return c = jspb.Message.getField(a, b),
    c || (c = [], jspb.Message.setField(a, b, c)),
...
jspb.Message.setOneofField = function(a, b, c, d) { (c = jspb.Message.computeOneofCase(a, c)) && c !== b && void 0 !== d && (a.wrappers_ && c in a.wrappers_ && (a.wrappers_[c] = void 0), jspb.Message.setField(a, c, void 0));
...
jspb.Message.toMap = function(a, b, c, d) {
    for (var e = {},
    f = 0; f < a.length; f++) e[b.call(a[f])] = c ? c.call(a[f], d, a[f]) : a[f];
    return e
};
...
jspb.Message.prototype.getExtension = function(a) {
    if (this.extensionObject_) {
        ...
        var b = a.fieldIndex;
        if (a.isRepeated) {
            if (a.isMessageType()) return this.wrappers_[b] || (this.wrappers_[b] = goog.array.map(this.extensionObject_[b] || [],
            function(b) {
                return new a.ctor(b)
            })),
            this.wrappers_[b]
...
jspb.Message.prototype.setExtension = function(a, b) {
    ...
    var c = a.fieldIndex;
    a.isRepeated ? (b = b || [], a.isMessageType() ? (this.wrappers_[c] = b, this.extensionObject_[c] = goog.array.map(b,
    function(a) {
        return a.toArray()
...
jspb.utils.splitFloat64 = function(a) {
    var b = 0 > a ? 1 : 0;
    a = b ? -a: a;
    if (0 === a) jspb.utils.split64High = 0 < 1 / a ? 0 : 2147483648,
    jspb.utils.split64Low = 0;
    else if (isNaN(a)) jspb.utils.split64High = 2147483647,
    jspb.utils.split64Low = 4294967295;
    else if (a > jspb.BinaryConstants.FLOAT64_MAX) jspb.utils.split64High = (b << 31 | 2146435072) >>> 0,
    jspb.utils.split64Low = 0;
...
jspb.utils.hexStringToHash64 = function(a) {
    ...
    for (var b = "",
    c = 0; 8 > c; c++) var d = jspb.utils.DIGITS.indexOf(a[2 * c + 2]),
...
jspb.utils.countDelimitedFields = function(a, b, c, d) {
    ...
    for (d = 8 * d + jspb.BinaryConstants.WireType.DELIMITED; b < c;) {
        ...
        e++;
        for (var g = 0,
        h = 1; f = a[b++], g += (f & 127) * h, h *= 128, 0 != (f & 128););
        b += g
    }
    return e
};
...
jspb.BinaryDecoder.prototype.readSplitVarint64_ = function() {
    for (var a, b = 0,
    c, d = 0; 4 > d; d++) if (a = this.bytes_[this.cursor_++], b |= (a & 127) << 7 * d, 128 > a) {
        this.tempLow_ = b >>> 0;
        this.tempHigh_ = 0;
        return
    }
...
jspb.BinaryDecoder.prototype.readUnsignedVarint32 = function() {
    ...
    a = b[this.cursor_ + 0];
    var c = a & 127;
    if (128 > a) return this.cursor_ += 1,
    goog.asserts.assert(this.cursor_ <= this.end_),
    c;
    a = b[this.cursor_ + 1];
    c |= (a & 127) << 7;
    if (128 > a) return this.cursor_ += 2,
    goog.asserts.assert(this.cursor_ <= this.end_),
    c;
    a = b[this.cursor_ + 2];
    c |= (a & 127) << 14;
    if (128 > a) return this.cursor_ += 3,
    goog.asserts.assert(this.cursor_ <= this.end_),
    c;
    a = b[this.cursor_ + 3];
    c |= (a & 127) << 21;
    if (128 > a) return this.cursor_ += 4,
    goog.asserts.assert(this.cursor_ <= this.end_),
    c;
    a = b[this.cursor_ + 4];
    c |= (a & 15) << 28;
    if (128 > a) return goog.asserts.assert(0 == (a & 240)),
    this.cursor_ += 5,
    goog.asserts.assert(this.cursor_ <= this.end_),
    c >>> 0;
...
jspb.BinaryDecoder.prototype.readBytes = function(a) {
    if (0 > a || this.cursor_ + a > this.bytes_.length) return this.error_ = !0,
...
jspb.BinaryReader.prototype.nextField = function() {
    ...
    if (this.getError()) return goog.asserts.fail("Decoder hit an error"),
    !1;
    this.fieldCursor_ = this.decoder_.getCursor();
...
jspb.BinaryEncoder.prototype.writeSignedVarint32 = function(a) {
    ...
    if (0 <= a) this.writeUnsignedVarint32(a);
        ...
        for (var b = 0; 9 > b; b++) this.buffer_.push(a & 127 | 128),
        a >>= 7;
        this.buffer_.push(1)
    }
};
...
jspb.arith.UInt64.mul32x32 = function(a, b) {
    ...
    e = b & 65535,
    f = b >>> 16,
    g = c * e + 65536 * (c * f & 65535) + 65536 * (d * e & 65535), c = d * f + (c * f >>> 16) + (d * e >>> 16); 4294967296 <= g;) g -= 4294967296,
    c += 1;
...
jspb.arith.UInt64.prototype.div = function(a) {
    ...
    for (var d = new jspb.arith.UInt64(1, 0); ! a.msb();) a = a.leftShift(),
    d = d.leftShift();
    for (; ! d.zero();) 0 >= a.cmp(c) && (b = b.add(d), c = c.sub(a)),
    a = a.rightShift(),
    d = d.rightShift();
    return [b, c]
};
...
jspb.BinaryWriter.prototype.endDelimited_ = function(a) {
    ...
    for (goog.asserts.assert(0 <= b); 127 < b;) a.push(b & 127 | 128),
    b >>>= 7,
    this.totalLength_++;
    a.push(b);
    this.totalLength_++
